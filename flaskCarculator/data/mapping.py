...
TWO_WHEELER_POWERTRAINS = load_yaml("two-wheeler/powertrain.yaml")
TWO_WHEELER_SIZES = load_yaml("two-wheeler/size.yaml")
TWO_WHEELER_BATTERIES = load_yaml("two-wheeler/battery.yaml")
